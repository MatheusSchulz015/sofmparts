...
public class Configurations extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Português Brasil", "Inglês", " " }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Configurations.super.dispose();
           
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        this.dispose();
        if("Inglês".equals(jComboBox1.getSelectedItem())){
           this.dispose();
           loadingidioma lol = new loadingidioma();
           String idioma;
           idioma = "Inglês";
           lol.setIdioma(idioma);
           lol.setVisible(true);
 this.dispose();
       }else if("Português Brasil".equals(jComboBox1.getSelectedItem())){
           this.dispose();
           loadingidioma lol = new loadingidioma();
           String idioma;
           idioma = "Português Brasils";
           lol.setIdioma(idioma);
           lol.setVisible(true);
           this.dispose();
